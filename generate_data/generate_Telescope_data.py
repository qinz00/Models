    ...
    for jj in range(10):
        ...
        for index in range(500):
            ...
            mass1_list, mass2_list, spin1z_list, spin2z_list, right_ascension_list, declination_list, signal_E1_list, signal_E2_list, signal_E3_list, snr_E1_list, snr_E2_list, snr_E3_list = (
                generate_antena_response((10, 80), (10, 80), (0, 0.998), (0, 0.998), noiseE1, noiseE2, noiseE3, psd))
            data.append(data_sample(np.array(noiseE1), np.array(noiseE2), np.array(noiseE3), mass1_list, mass2_list,
                                    spin1z_list, spin2z_list, right_ascension_list,
                                    declination_list, signal_E1_list, signal_E2_list, signal_E3_list, snr_E1_list,
                                    snr_E2_list, snr_E3_list))
        with open(' ./data/' + output_file_name + str(jj + 1) + '.pkl', 'wb') as f:
            pickle.dump(data, f)
